...
class AutopartsSql {
  ...
  static List<AutopartBrand> getSeedAutopartBrand() {
    return [
      AutopartBrand(id: 1, name: 'Bosch', logo: 'https://picsum.photos/id/1/600/250'),
      AutopartBrand(id: 2, name: 'NGK', logo: 'https://picsum.photos/id/1/600/250'),
      AutopartBrand(id: 3, name: 'Valeo', logo: 'https://picsum.photos/id/1/600/250'),
      AutopartBrand(id: 4, name: 'Gates', logo: 'https://picsum.photos/id/1/600/250'),
      AutopartBrand(id: 5, name: 'Denso', logo: 'https://picsum.photos/id/1/600/250'),
    ];
  }
  ...
  static List<Autopart> getSeedAutopart() {
    return [
      ...
      Autopart(id: 3, brandId: 3, categoryId: 3), // Pastillas de freno Valeo, Frenos
      Autopart(id: 4, brandId: 4, categoryId: 2), // Amortiguador Gates, Suspensión
      ...
      Autopart(id: 8, brandId: 3, categoryId: 2), // Resorte de suspensión Valeo, Suspensión
      Autopart(id: 9, brandId: 4, categoryId: 5), // Batería Gates, Eléctrico
      Autopart(id: 10, brandId: 5, categoryId: 1), // Sensor de oxígeno Denso, Motor
    ];
  }
  ...
  {
    return [
      Country(id: 1, name: 'Argentina', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+54'),
      Country(id: 2, name: 'Brasil', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+55'),
      Country(id: 3, name: 'Chile', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+56'),
      Country(id: 4, name: 'Colombia', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+57'),
      Country(id: 5, name: 'México', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+52'),
      Country(id: 6, name: 'Perú', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+51'),
      Country(id: 7, name: 'Estados Unidos', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+1'),
      Country(id: 8, name: 'España', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+34'),
      Country(id: 9, name: 'Francia', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+33'),
      Country(id: 10, name: 'Alemania', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+49'),
      Country(id: 11, name: 'Italia', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+39'),
      Country(id: 12, name: 'Reino Unido', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+44'),
      Country(id: 13, name: 'Japón', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+81'),
      Country(id: 14, name: 'Australia', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+61'),
      Country(id: 15, name: 'Canadá', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+1'),
      Country(id: 16, name: 'Bolivia', photo: 'https://picsum.photos/id/1/600/250', codePhone: '+591'),
    ];
  }
