...
class CatalogPage extends StatefulWidget {
  static String name = "catalog_page";
...
class _CatalogPageState extends State<CatalogPage> {
  // Lista de autopartes disponibles
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cotización al por Mayor'),
        centerTitle: true,
        actions: [
            ...
            children: [
              ...
              Center(
                child: CircleAvatar(
                  ...
                  child: const Icon(Icons.car_repair, size: 40, color: Colors.blueGrey),
            ...
            children: [
              Center(
                child: CircleAvatar(
                  radius: 50,
                  backgroundColor: Colors.grey[200],
                  child: const Icon(Icons.car_repair, size: 50, color: Colors.blueGrey),
                ),
              ),
              ...
              _buildDetailRow('Precio unitario', '${part.price.toStringAsFixed(2)} Bs'),
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text('La cotización ha sido creada exitosamente. ¿Deseas enviarla por correo?'),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
